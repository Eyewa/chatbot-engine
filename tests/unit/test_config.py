...
from app.core.config import (ChatSettings, DatabaseSettings, LLMSettings,
                             MonitoringSettings, Settings, get_database_uri,
                             get_llm_config, get_settings)
...
class TestMonitoringSettings:
    ...
    def test_custom_values(self):
        ...
        settings = MonitoringSettings(
            enabled=False, log_file="custom.log", dashboard_port=9000
        )
...
class TestChatSettings:
    ...
    def test_custom_values(self):
        ...
        settings = ChatSettings(
            include_chat_history=True, max_history_tokens=4000, conversation_ttl=3600
        )
...
class TestSettings:
    ...
    def test_default_values(self):
        ...
        settings = Settings(llm=LLMSettings(api_key="test_key"))
