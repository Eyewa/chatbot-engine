...
class ChatSettings(BaseModel):
    ...
    conversation_ttl: int = Field(default=86400, description="Conversation TTL")  # 24 hours
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        database=DatabaseSettings(
            live_db_uri=os.getenv("LIVE_DB_URI", "mysql+pymysql://read_only:Aukdfduyje983idbj@db.eyewa.internal:3306/eyewa_live"),
            common_db_uri=os.getenv("COMMON_DB_URI", "mysql+pymysql://read_only:Aukdfduyje983idbj@db.eyewa.internal:3306/eyewa_common"),
        ),
        ...
        chat=ChatSettings(
            include_chat_history=os.getenv("INCLUDE_CHAT_HISTORY", "false").lower() == "true",
